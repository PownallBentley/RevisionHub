  ...
  const stats = [
    {
      ...
      subtext:
        summary.comparison_to_last_week !== 0
          ? `${summary.comparison_to_last_week > 0 ? "↑" : "↓"} ${Math.abs(
              summary.comparison_to_last_week
            )} ${summary.comparison_to_last_week > 0 ? "more" : "fewer"} than last week`
          : null,
    ...
    },
    {
      ...
      subtext: `Across ${summary.subjects_span} subject${
        summary.subjects_span !== 1 ? "s" : ""
      }`,
